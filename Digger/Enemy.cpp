...
void Enemy::chase(Map& map, int playerX, int playerY)
{
    ...
    SDL_Point enemyCoordinates = { xpos/TILE,  (ypos - MAP_OFFSET_Y)/ TILE };

    //std::cout << "PLAYER TILE: "
    //    << playerCoordinates.x << ","
    //    << playerCoordinates.y << std::endl;

    //std::cout << "IS WALKABLE: "
    //    << map.isWalkable(playerCoordinates.x, playerCoordinates.y)
    //    << std::endl;
    //  
